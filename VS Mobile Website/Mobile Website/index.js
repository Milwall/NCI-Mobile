...
$(document).ready(function () {
	...
	*/
	...
	//double equals will check to see if the two types are equal even though they are not the same type 
	//treble equals will check if they are exactly equal (types taken into account)
	if(aNumber == "10"){
